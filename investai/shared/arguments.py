...
def parse_arguments() -> Tuple[vars, Namespace]:
    ...
    parser.add_argument("--replay-buffer-kwargs", help="Additional argument to pass to the replay buffer on creation",
    ...
    parser.add_argument("--exploration-fraction", help="Fraction of raining period over the explor. rate is annealed",
